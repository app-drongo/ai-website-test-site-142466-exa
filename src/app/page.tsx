...
const DEFAULT_PAGE = {
  ...
  contactSubtitle: "Ready to transform your business? We'd love to hear from you.",
  contactEmail: 'hello@company.com',
  contactPhone: '+1 (555) 123-4567',
  contactAddress: '123 Business Ave, Suite 100, City, State 12345',
  contactFormTitle: 'Send us a message',
  ctaTitle: 'Ready to Get Started?',
  ctaSubtitle: 'Join thousands of companies already transforming their business with our platform.',
    ...
    <>
      ...
      <section id="cta" className="bg-primary text-primary-foreground">
        <CallToAction
          ...
          secondaryCtaText={config.ctaSecondaryText}
          secondaryCtaHref={config.ctaSecondaryHref}
        />
      </section>
    </>
  );
